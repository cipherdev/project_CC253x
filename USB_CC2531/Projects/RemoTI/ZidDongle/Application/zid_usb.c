/**************************************************************************************************
  ...
  This file contains the definitions for a ZID Profile HID Adapter implementing the CC2531 USB.

  There is an optionally compiled Endpoint for Consumer Electronics control when
  ZID_USB_CE is defined. Usages are:
    Volume Up, Volume Dn, Mute, Power, Recall Last, Assign Selection, Play, Pause,
    Record, Fast Forward, Rewind, Scan Next, Scan Prev, Stop.

  And there is an optionally compiled Endpoint for proprietary control of the RNP when
  ZID_USB_RNP is defined.
