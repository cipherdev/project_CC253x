/**************************************************************************************************
  Filename:       hal_mcu.h
  Revised:        $Date: 2012-09-13 15:42:47 -0700 (Thu, 13 Sep 2012) $
  Revision:       $Revision: 31529 $

  Description:

  H/W & MCU-specific abstractions for the Texas Instruments CC2533 (8051 core) SOC.
...
// Set FORCE_RESET bit to force an immediate watchdog reset.
#define HAL_SYSTEM_RESET()  st( SRCRC = BV(5); )
...
/* SRCRC bit definitions */
#define XOSC_AMP_DET_EN  BV(7)      /* Enable amplitude detector for the 32-MHz XOSC */
