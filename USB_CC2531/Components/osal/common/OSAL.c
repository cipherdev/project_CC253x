/**************************************************************************************************
  Filename:       OSAL.c
  Revised:        $Date: 2011-04-14 19:31:38 -0700 (Thu, 14 Apr 2011) $
  Revision:       $Revision: 25721 $
...
#if defined( POWER_SAVING )
    // Complete pass with no task activity and no wake-from-sleep ISR?
    if ((idx == tasksCnt) && CHECK_SLEEP_MODE())
    {
