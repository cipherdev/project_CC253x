/**************************************************************************************************
  ...
  Revised:        $Date: 2012-08-23 16:02:32 -0700 (Thu, 23 Aug 2012) $
  Revision:       $Revision: 31366 $
...
#define MAC_RADIO_SET_PAN_COORDINATOR(b)              st( FRMFILT0 = (FRMFILT0 & (PAN_COORDINATOR ^ 0xFF)) | (PAN_COORDINATOR * (b!=0)); )
...
#define MAC_RADIO_TIMER_SLEEP()                       st(T2CTRL &= (TIMER2_RUN ^ 0xFF); while(  T2CTRL & TIMER2_STATE);)
...
#define MAC_RADIO_BACKOFF_COMPARE_DISABLE_INTERRUPT()  st( T2IRQM &= (TIMER2_OVF_COMPARE1M ^ 0xFF); )
...
#define MAC_RADIO_BACKOFF_PERIOD_DISABLE_INTERRUPT()  st( T2IRQM &= (TIMER2_OVF_PERM ^ 0xFF); )
...
#define MAC_RADIO_TURN_OFF_RX_FRAME_FILTERING()       st( FRMFILT0 &= (FRAME_FILTER_EN ^ 0xFF); )
...
#define MAC_RADIO_TURN_OFF_PENDING_OR()               st( FRMCTRL1 &= (PENDING_OR ^ 0xFF); )
