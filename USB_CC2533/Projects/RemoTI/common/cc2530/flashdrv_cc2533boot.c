/**************************************************************************************************
  Filename:       flashdrv_cc2533boot.c
  Revised:        $Date: 2011-09-07 18:03:16 -0700 (Wed, 07 Sep 2011) $
  Revision:       $Revision: 27485 $

  Description:    Implementation of flash driver for CC2533 boot loader.
 ...
 * input parameters
 *
 * @param       pg - Virtual flash page number (1 page = 2048 bytes).
 ...
 * input parameters
 *
 * @param       pg - virtual page to erase (1 page = 2048 bytes)
 *
 * output parameters
 *
 * None.
