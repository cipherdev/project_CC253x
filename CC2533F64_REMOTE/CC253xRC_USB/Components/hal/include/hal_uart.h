/**************************************************************************************************
  Filename:       hal_uart.h
  Revised:        $Date: 2010-09-09 17:32:44 -0700 (Thu, 09 Sep 2010) $
  Revision:       $Revision: 23720 $
...
#define HAL_UART_RX_WAKEUP       0x08
#define HAL_UART_TX_FULL         0x10
#define HAL_UART_TX_EMPTY        0x20
...
/*
 * Query for UART activity before entering sleep mode.
 */
extern uint8 HalUARTBusy(void);

/*
 * Suspend UART when entering sleep mode
 */
