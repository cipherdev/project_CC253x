/**************************************************************************************************
  ...
  Description:    Declarations for the CC2530EM used as the NPI.
 ...
 */
    ...
    !defined (HAL_BOARD_CC2530RB)
  #define HAL_BOARD_CC2530RB
#endif
...
#elif defined (HAL_BOARD_CC2530EB_REV13) || defined (HAL_BOARD_CC2530RB) ||\
      defined (HAL_PA_LNA) || defined (HAL_PA_LNA_CC2590)
...
#elif defined (HAL_BOARD_CC2530RB)
  /* 2 - Red */
  #define LED2_BV           BV(0)
...
#define HAL_I2C       FALSE  // I2C is only available on the CC2533.
#ifndef HAL_SPI
