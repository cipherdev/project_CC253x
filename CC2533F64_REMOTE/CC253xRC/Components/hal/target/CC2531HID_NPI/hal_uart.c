/**************************************************************************************************
  ...
  Revised:        $Date: 2011-03-07 09:45:14 -0800 (Mon, 07 Mar 2011) $
  Revision:       $Revision: 25300 $
...
#endif
#if HAL_UART_USB
  // USB is interrupt driven & obeys SUSPEND/RESUME, so never busy.
#endif
  return rtrn;
}
