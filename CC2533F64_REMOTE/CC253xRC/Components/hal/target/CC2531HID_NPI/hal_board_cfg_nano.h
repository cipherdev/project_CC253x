...
/* ----------- Push Buttons ---------- */
//FLE #define HAL_PUSH_BUTTON1()        (PUSH1_POLARITY (PUSH1_SBIT))
//FLE #define HAL_PUSH_BUTTON2()        (PUSH2_POLARITY (PUSH2_SBIT))
