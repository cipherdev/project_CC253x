/**************************************************************************************************
  Filename:       hal_key.c
  Revised:        $Date: 2010-10-16 19:20:48 -0700 (Sat, 16 Oct 2010) $
  Revision:       $Revision: 24132 $

  Description:    This file contains the interface to the CC2533 HAL KEY Service.
...
#if !defined PUSH1_POLARITY_ENUM
#define HAL_KEY_SW_6_EDGE     HAL_KEY_FALLING_EDGE
#else
#if PUSH1_POLARITY_ENUM == ACTIVE_HIGH_ENUM
...
void HalKeyConfig (bool interruptEnable, halKeyCBack_t cback)
{
  ...
  if (Hal_KeyIntEnable)
  {
    ...
    HAL_KEY_SW_6_PXIFG = (HAL_KEY_SW_6_BIT ^ 0xFF);
    ...
    HAL_KEY_JOY_MOVE_PXIFG = (HAL_KEY_JOY_MOVE_BIT ^ 0xFF);
...
void halProcessKeyInterrupt (void)
{
  ...
  {
    HAL_KEY_SW_6_PXIFG = (HAL_KEY_SW_6_BIT ^ 0xFF); /* Clear Interrupt Flag */
    valid = TRUE;
  }

  if (HAL_KEY_JOY_MOVE_PXIFG & HAL_KEY_JOY_MOVE_BIT)  /* Interrupt Flag has been set */
  {
    HAL_KEY_JOY_MOVE_PXIFG = (HAL_KEY_JOY_MOVE_BIT ^ 0xFF); /* Clear Interrupt Flag */
    valid = TRUE;
  }
