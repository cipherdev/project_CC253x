/**************************************************************************************************
  ...
  Revised:        $Date: 2012-11-01 12:41:00 -0700 (Thu, 01 Nov 2012) $
  Revision:       $Revision: 32006 $
...
MAC_INTERNAL_API void macCspTxGoCsma(void)
{
   ...
   *
   *  RF4CE uses unslotted CSMA, which does not wait at least one backoff period before CCA.
   *  Instead, it just waits for valid RSSI before CCA. In this case, do not subtract one
   *  from CSPX.
   */
